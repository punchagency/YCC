        ...
        >
          ...
          >
            ...
            >
              ...
              >
                <CustomOPtionText>
                  {chatData.chatSuggestions[0] || chatSuggestions[role][0]}
                </CustomOPtionText>
              </CustomOptionButton>
              <CustomOptionButton
                onClick={() =>
                  preDefinedMessages(
                    chatData.chatSuggestions[1] || chatSuggestions[role][1]
                  )
                }
              >
                <CustomOPtionText>
              ...
              <CustomOptionButton
                onClick={() =>
                  preDefinedMessages(
                    chatData.chatSuggestions[2] || chatSuggestions[role][2]
                  )
                }
              >
                <CustomOPtionText>
              ...
              <CustomOptionButton
                onClick={() =>
                  preDefinedMessages(
                    chatData.chatSuggestions[3] || chatSuggestions[role][3]
                  )
                }
              >
                <CustomOPtionText>
                  ...
                  {chatData.messages.map((item) => (
                    ...
                    >
                      ...
                      >
                        {item.role === "assistant" && (
                          <>
                            <Box>{/* Bot icon would go here if needed */}</Box>
                            <ChatbotTime>
                              Chatbot{" "}
                              {formatUtcTo12Hour(
                                item.createdAt
