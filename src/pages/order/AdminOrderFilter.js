...
const AdminOrderFilter = ({
  ...
  return (
    ...
    >
      {/* Modern, rounded, single-icon Search Bar */}
      <form
      ...
      >
        ...
        >
          ...
          />
          <span style={{ marginLeft: 8, fontSize: 15 }}>Filter Orders</span>
        </Box>
        <Box
        ...
        >
          ...
          >
            <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
              <i
                className={
                  orderFilters.find((f) => f.key === activeFilter)?.icon
                }
                style={{
                  color: orderFilters.find((f) => f.key === activeFilter)
                    ?.color,
                }}
              />
              <span>
