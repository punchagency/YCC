...
const nationalities = countryList.getData().map((country) => ({
  name: country.name,
  code: country.code,
}));
              ...
              <form className="grid">
                ...
                <div className="col-12">
                  <label htmlFor="upload-cv">
                    Upload Documents’ (with the integration of an AI Agent these
                    certificates would be selected and added to the profile)
                  </label>
