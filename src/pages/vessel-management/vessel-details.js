                ...
                <div className="card flex justify-content-center">
                  ...
                  >
                    <div className="details-content">
                      ...
                      <div className="details-content-text">10 meters</div>
                    </div>

                    <div className="details-content">
                      <div className="details-content-lable">Beam</div>
                      <div className="details-content-text">5 meters</div>
                    </div>

                    <div className="details-content">
                      <div className="details-content-lable">Draft</div>
                      <div className="details-content-text">2.1 meters</div>
                    </div>

                    <div className="details-content">
                      <div className="details-content-lable">Gross Tonnage</div>
                      <div className="details-content-text">200 GT</div>
                    </div>
                  </Card>
                </div>
              </div>
                ...
                <div className="card flex justify-content-center">
                  ...
                  >
                    <div className="details-content">
                      ...
                      <div className="details-content-text">10 Gas Turbine</div>
                    </div>
                    ...
                    <div className="details-content">
                      ...
                      <div className="details-content-text">2</div>
                    </div>
                  ...
                  >
                    <div className="details-overview">
                      <div className="details-content">
                        ...
                        <div className="details-content-text">Flag state</div>
                      </div>
                      <div className="details-content">
                        <div className="details-content-lable">
                          Issuing Authority
                      ...
                      <div className="details-content">
                        ...
                        <div className="details-content-text">Demo</div>
                      </div>
                      ...
                      <div className="details-content">
                        ...
                        <div className="details-content-text">22/03/2024</div>
                      </div>
                      ...
                      <div className="details-content">
                        ...
                        <div className="details-content-text">Demo Name</div>
                      </div>
                      <div className="details-content">
                        <div className="details-content-lable">Phone no</div>
                        <div className="details-content-text">8768767687</div>
                      </div>

                      <div className="details-content">
                        <div className="details-content-lable">Outcome</div>
                        <div className="details-content-text">demo outcome</div>
                      </div>
                      ...
                      <div className="details-content">
                        ...
                        <div className="details-content-text">demo report</div>
                      </div>
                ...
                <div className="card flex justify-content-center">
                  ...
                  >
                    ...
                    <div className="details-content">
                      ...
                      <div className="details-content-text">demo officer</div>
                    </div>
                    <div className="details-content">
                      <div className="details-content-lable">
                ...
                <div className="card flex justify-content-center">
                  ...
                  >
                    ...
                    <div className="details-content">
                      ...
                      <div className="details-content-text">Chief Engineer</div>
                    </div>
                    ...
                    <div className="details-content">
                      ...
                      <div className="details-content-text">12/11/2024</div>
                    </div>

                    <div className="details-content">
                      <div className="details-content-lable">Status</div>
                      <div className="details-content-text">Not started</div>
                    </div>
                    <div className="details-content">
                      <div className="details-content-lable">
                ...
                <div className="card flex justify-content-center">
                  ...
                  >
                    ...
                    <div className="details-content">
                      ...
                      <div className="details-content-text">PSC Inspection</div>
                    </div>
                  ...
                  >
                    <div className="details-overview">
                      <div className="details-content">
                        ...
                        <div className="details-content-text">demo task</div>
                      </div>
                      <div className="details-content">
                        <div className="details-content-lable">
                          Task Category
                      ...
                      <div className="details-content">
                        ...
                        <div className="details-content-text">12/02/2024</div>
                      </div>
                      <div className="details-content">
                        <div className="details-content-lable">
                ...
                <div className="card flex justify-content-center">
                  ...
                  >
                    ...
                    <div className="details-content">
                      ...
                      <div className="details-content-text">Internal Crew</div>
                    </div>
                    ...
                    <div className="details-content">
                      ...
                      <div className="details-content-text">8587568756756</div>
                    </div>
                    <div className="details-content">
                      <div className="details-content-lable">
                        {uploadedFiles.map((file, index) => {
                  ...
                  >
                    <div className="details-overview">
                      <div className="details-content">
                        ...
                        <div className="details-content-text">Maintenance</div>
                      </div>
                      <div className="details-content">
                        <div className="details-content-lable">Date</div>
                        <div className="details-content-text">12/11/2024</div>
                      ...
                      <div className="details-content">
                        ...
                        <div className="details-content-text">$300</div>
                      </div>
                      <div className="details-content">
                        <div className="details-content-lable">Description</div>
                        <div className="details-content-text">
                ...
                <div className="card flex justify-content-center">
                  ...
                  >
                    <div className="details-content">
                      ...
                      <div className="details-content-text">Charter</div>
                    </div>

                    <div className="details-content">
                      <div className="details-content-lable">Amount</div>
                      <div className="details-content-text">$400</div>
                    </div>
