       ...
       <div className="w-full right-panel-component">
          ...
          <div className="flex align-items-center justify-content-between sub-header-panel">
            <div className="sub-header-left sub-header-left-with-arrow">
              <div className='arrow'>
                  <Link to="/document-management/documents"> {/* Replace "/previous-page" with your target route */}
            ...
            <div className="sub-header-right">
              <Button label="Edit" icon="pi pi-user-edit" severity="secondary" outlined className="p-button-secondary mr-3" onClick={(e) => navigate(`/document-management/documents/edit`)}/>
            </div>
          </div>
          <div className="card-wrapper-gap">
                                ...
                                <Card className="details-card" title={
                                  ...
                                  <div className="details-overview">
                                      <div className="details-content">
                                          <div className="details-content-lable">Document Name</div>
                                      ...
                                      <div className="details-content">
                                          <div className="details-content-lable">Associated vessel</div>
                                          <div className="details-content-text">
                                          The Black Pearl
                                          </div>
                                      </div>
            ...
            >
                <DataTable value={data} autoLayout className="p-datatable-sm">
