                            ...
                            <div className="card flex justify-content-center">
                                <Card className="details-card" title={
                                  ...
                                  <div className="details-overview">
                                      ...
                                      <div className="details-content">
                                          <div className="details-content-lable">Date of Birth</div>
                                          <div className="details-content-text">
                                              3rd Dec, 1987
                                          </div>
                                      </div>
                                      ...
                                      <div className="details-content">
                                          ...
                                          <div className="details-content-text">
                                              864 E Broad Street, Fort Queenton, Missouri - 41138, United States of America
                                          </div>
                                      </div>
                                  </div>
                                </Card>
                            ...
                            <div className="card flex justify-content-center">
                                <Card className="details-card" title={
                                  ...
                                  <div className="details-overview">
                                      ...
                                      <div className="details-content">
                                          <div className="details-content-lable">Relationship</div>
                                          <div className="details-content-text">
                                              Wife
                                          </div>
                                      </div>
                                      <div className="details-content">
                                          <div className="details-content-lable">Contact Number</div>
                                          <div className="details-content-text">
                                            (480) 555-0103
                                          </div>
                                      </div>
                            ...
                            <div className="card flex justify-content-center">
                                <Card className="details-card" title={
                                  ...
                                  <div className="details-overview">
                                      ...
                                      <div className="details-content">
                                          <div className="details-content-lable">Years of Experience</div>
                                          <div className="details-content-text">
                                              12
                                          </div>
                                      </div>
                                      <div className="details-content">
                                          <div className="details-content-lable">Certifications</div>
                                          <div className="details-content-text">
                                              devon@yachtcrewcenter.com
                                          </div>
                                      </div>
                        ...
                        <div className='item'>
                            <div className="card flex justify-content-center">
                                <Card className="details-card" title={
                                  ...
                                  <div className="details-overview">
                                      <div className="details-content">
                                          <div className="details-content-lable">Medical 
                                          Restrictions</div>
                                          <div className="details-content-text">
                                              Peanuts, tree nuts, dairy, gluten, or eggs. Yacht kitchens often need to accommodate dietary restrictions for safety.
                                          </div>
                                      </div>
                                  </div>
                                </Card>
