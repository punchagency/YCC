                ...
                <div>
                  ...
                  <div style={{ lineHeight: "2" }}>
                    <div className="detail-item flex gap-6">
                      ...
                      <span className="labelValue">Main Engine</span>
                    </div>
                    <div className="detail-item flex gap-6">
                      <span className="labelName">Category</span>{" "}
                      <span className="labelValue">Engine</span>
                    </div>
                    <div className="detail-item flex gap-6">
                      <span className="labelName">Manufacturer</span>{" "}
                      <span className="labelValue">Caterpillar</span>
                    </div>
                    <div className="detail-item flex gap-6">
                      <span className="labelName"> Model Number </span>{" "}
                      <span className="labelValue">3516E</span>
                    </div>
                    <div className="detail-item flex gap-6">
