...
const Maintenance = () => {
    ...
    setTimeout(() => {
      const fetchedTasks = [
        ...
        },
        {
          ...
          vesselName: "AquaHolic",
          assignPersonal: "Theresa Webb",
          date: "23/10/2024",
          priority: "Medium",
          status: "InProgress",
          attachment: "file1.pdf",
  ...
  const applyFilters = useCallback(() => {
    ...
    if (selectedVesselName) {
      filteredData = filteredData.filter(
        (vessel) => vessel.vesselName === selectedVesselName
      );
    }
    if (selectedDate) {
  ...
  const date = [...new Set(maintenanceTasks.map((vessel) => vessel.date))].map(
    ...
    <>
      ...
      <div className="card-wrapper-gap">
        <DataTable
          ...
          onRowClick={(e) =>
            navigate(`/maintenance-scheduling/maintenance/${e.data.id}`)
          }
