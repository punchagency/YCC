...
const AddCompliance = () => {
  ...
  const authority = [{ name: "USCG" }, { name: "USCB" }];

  const outcomes = [{ name: "demo1" }, { name: "demo2" }];

  const categories = [{ name: "Environmental" }, { name: "demo2" }];
  const deficiencies = [{ name: "demo1" }, { name: "demo2" }];
  ...
  const actionStatuses = [{ name: "Not Started" }, { name: "Started" }];

  const complianceStatuses = [{ name: "Yes" }, { name: "No" }];
                    ...
                    <div className="grid">
                      ...
                      <div className="col-12">
                        <div className="flex align-content-center mt-2 action-toggle">
                          <p className="mr-5 font-medium action-label">
                            Action Required
                          </p>
                          <InputSwitch
                            checked={action}
                      ...
                      <div className="col-12">
                        <label htmlFor="actionDescription">
                          Action Description{" "}
                          <span className="text-xs">( Mention in detail )</span>
                        </label>
                        <InputTextarea
