                                    ...
                                    <div className="grid">
                                        ...
                                        <div className="col-6">
                                            ...
                                            <Dropdown
                                                ...
                                                optionLabel="name"
                                                placeholder={paymentMethods.length > 0 ? paymentMethods[0].name : "Select"}
                                                className="w-full mt-2"
                                            />
                                        </div>
                                        <div className="col-6">
                                        ...
                                        <div className="col-6">
                                            ...
                                            <Dropdown
                                                ...
                                                optionLabel="name"
                                                placeholder={paymentStatuses.length > 0 ? paymentStatuses[0].name : "Select"}
                                                className="w-full mt-2"
                                            />
                                        </div>
                                        ...
                                        <div className="col-12">
                                            <label htmlFor="expenseReport">Expense Description (Notes)</label>
                                            <InputTextarea
                                                id="expenseReport"
                                                value={expenseReport}
                                ...
                                <form>
                                    <div className="grid">
                                        <div className="col-6">
                                            ...
                                            />
                                            <label htmlFor="singleExpense" className='ml-2'>Single Expense</label>
                                        ...
                                        <div className="col-6">
                                            ...
                                            />
                                            <label htmlFor="singleExpense" className='ml-2'>Recurring Expense</label>
                                        ...
                                        <div className="col-6">
                                            <label htmlFor="maintenanceFrequency">Expense Category</label>
                                            <Dropdown
                                                ...
                                                optionLabel="name"
                                                placeholder={maintenanceFrequencies.length > 0 ? maintenanceFrequencies[0].name : "Select"}
                                                className="w-full mt-2"
                                            />
                                        </div>
