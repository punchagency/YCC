                ...
                <div>
                  ...
                  <div style={{ lineHeight: "2" }}>
                    <div className="detail-item flex gap-6">
                      ...
                      <span className="labelValue">#YC98564</span>
                    </div>
                    <div className="detail-item flex gap-6">
                      <span className="labelName">Vendor</span>
                    ...
                    <div className="detail-item flex gap-6">
                      <span className="labelName">Due Date</span>
                    ...
                    <div className="detail-item flex gap-6">
                      ...
                      <span className="labelValue">2 Days</span>
                    </div>
