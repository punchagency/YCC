                ...
                >
                  <div className="details-overview">
                    ...
                    <div className="details-content">
                      ...
                      <div className="details-content-text">14/12/2024</div>
                    </div>
                    <div className="details-content">
                    ...
                    <div className="details-content">
                      ...
                      <div className="details-content-text">08:45PM</div>
                    </div>
                    <div className="details-content">
                      <div className="details-content-lable">End Time</div>
                      <div className="details-content-text">09:45PM </div>
                    </div>
                  </div>
                </Card>
              </div>
            ...
            <div className="card bg-white p-4 border-round-lg">
              ...
              <div className="content mb-4">
                ...
                <p className="contentPara mt-3">
                  ...
                  Nullam tincidunt, nisi nec pharetra egestas, sem elit luctus
                  odio, at egestas nibh risus id nisl. Vestibulum non enim sit
                  amet libero dictum cursus id quis felis. Lorem ipsum dolor sit
                  amet, consectetur adipiscing elit. Nullam tincidunt, nisi nec
                  pharetra egestas, sem elit luctus odio, at egestas nibh risus
                  id nisl. Vestibulum non enim sit amet libero dictum cursus id
                  quis felis. 
                </p>
              </div>
              ...
              <div className="content mb-4">
                ...
                <p className="contentPara mt-3">
                  ...
                  Nullam tincidunt, nisi nec pharetra egestas, sem elit luctus
                  odio, at egestas nibh risus id nisl. Vestibulum non enim sit
                  amet libero dictum cursus id quis felis. 
                </p>
              </div>
