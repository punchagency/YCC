...
import { fetchCrewNotifications, markNotificationAsRead } from "../../../services/crew/crewNotificationService"
...
const MobileNotificationCard = ({ notification, handleViewDetails, handleStatusChange, statusLoading, theme }) => {
  ...
  const priorityStyle = priorityStyles[(notification?.type || "").toLowerCase()] || {
    bg: "#F2F4F7",
    color: "#344054",
  }
...
const NotificationFilter = ({ activeFilter, activeStatusFilter, onFilterChange, onStatusFilterChange, isMobile }) => {
  ...
  const priorityFilters = [
    ...
    { key: "order", label: "Order", icon: "pi pi-shopping-cart", color: "#027A48" },
    { key: "booking", label: "Booking", icon: "pi pi-calendar", color: "#B54708" },
    { key: "inventory", label: "Inventory", icon: "pi pi-box", color: "#B42318" },
